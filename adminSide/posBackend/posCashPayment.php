            ...
            <div class="card mt-4">
                ...
                <div class="card-body">
                    ...
                    <div class="text-right">
                        <?php
                        echo "<strong>Total:</strong> NPR " . number_format($cart_total, 2) . "<br>";
                        echo "<strong>Discount:</strong> NPR " . number_format("0" * $tax, 2) . "<br>";
                        $GRANDTOTAL = $cart_total;
                        echo "<strong>Grand Total:</strong> NPR " . number_format($GRANDTOTAL, 2);
                        ?>
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        if (isset($_GET['payment_amount'])) {
                            ...
                            if ($payment_amount >= $GRANDTOTAL) {
                                ...
                                echo "Change is NPR" . number_format(calculateChange($payment_amount, $GRANDTOTAL), 2);
                                echo '</div>';
                                ...
                                staff_id = $staff_id, member_id = $member_id

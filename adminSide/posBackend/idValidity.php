        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            if (!$result) {
                ...
                if ($staffExists && $memberExists && $reservationExists) {
                    ...
                    echo "Staff and member id are valid.";
                    echo '</div>';
                    echo '<div class="mt-3">';
                    echo '<a href="posCashPayment.php?bill_id=' . $bill_id . '&staff_id=' . $staffId . '&member_id=' . $memberId . '" class="btn btn-success">Cash</a>';
                    // echo '<a href="posCardPayment.php?bill_id=' . $bill_id . '&staff_id=' . $staffId . '&member_id=' . $memberId . '" class="btn btn-primary ml-2">Credit Card</a>';
